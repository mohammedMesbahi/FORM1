...
public class MySqlConn{
    ...
    public static int creatTeam(String country,String teamName,String competation,Integer ranking) throws SQLException {

        String qr = "insert into Team values('" + teamName + "');";
        int generatedKey = -1;
